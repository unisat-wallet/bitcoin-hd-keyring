...
describe("bitcoin-hd-keyring", () => {
  ...
  describe("more words test", () => {
    ...
    it("15 words", async () => {
      const sampleMnemonic = "gloom prepare pause lazy item valley pear develop ahead crucial fuel seed bone reward shoot";
    ...
    it("18 words", async () => {
      const sampleMnemonic = "machine chest second galaxy rally design stumble code address general twelve job code acquire dutch debate jealous truly";
    ...
    it("21 words", async () => {
      const sampleMnemonic = "squirrel spawn fog zero approve connect mirror social basic about alert yellow giraffe oak company file finger winner coast cushion oxygen";
    ...
    it("24 words", async () => {
      const sampleMnemonic = "dash pair decline scrap federal marine erase lounge fancy quick valid crawl wing ahead art chaos deposit rare deputy gaze often fence alien picture";
  ...
  describe("support xpriv", () => {
    ...
    it("xpriv", async () => {
      const sampleXpriv = "xprvA2JBuYsdqVhrC2wGmb9QhBejk9gXXYgM3Jg9xgVYmDMsakDoURc8V7UYos1pP1kev1tG51PPA9A8VMYYCLov1L5c3J7npraxwjeJCquGhDi";
      const firstAccount = "0244ffe4b9f87b7c1e2f8b0d7dee2a91492fedf9c92fc06231764826633b2c8afa";
      const secondAccount = "0243906ea96ce2680826bfd906cdfcbb70cf2764e469518ba000f0aeb76a6b025b";
